...
* `priority_lasso` learners now support automatic block-priority derivation via `adaptive.order = TRUE`, following the approach in [Li et al. (2024)](http://doi.org/10.1186/S12911-024-02642-9).
