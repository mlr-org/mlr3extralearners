...
test_that("classif.SimpleLogistic train", {
  learner = lrn("classif.SimpleLogistic")
  fun = RWeka::make_Weka_classifier('weka/classifiers/functions/SimpleLogistic')
...
test_that("classif.SimpleLogistic predict", {
  # Here we test that the learner implements those arguments that are passed via the
  # control argument to RWeka::make_Weka_classifier('weka/classifiers/functions/SimpleLogistic')
  learner = lrn("classif.SimpleLogistic")
