...
test_that("classif.voted_perceptron train", {
...
test_that("classif.voted_perceptron predict", {
  # Here we test that the learner implements those arguments that are passed via the
  # control argument to RWeka::make_Weka_classifier('weka/classifiers/functions/VotedPerceptron')
  learner = lrn("classif.voted_perceptron")
