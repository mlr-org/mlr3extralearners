test_that("autotest", {
  ...
  suppressMessages(capture.output({result_logical = run_autotest(
    learner,
  ...
  suppressMessages(capture.output({result_factor = run_autotest(
    learner,
  ...
  suppressMessages(capture.output({result_integer = run_autotest(
    learner,
  ...
  suppressMessages(capture.output({result_all = run_autotest(
    learner,
