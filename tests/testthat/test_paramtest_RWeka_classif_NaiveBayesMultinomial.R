...
test_that("classif.NaiveBayesMultinomial train", {
  learner = lrn("classif.NaiveBayesMultinomial")
  fun = RWeka::make_Weka_classifier("weka/classifiers/bayes/NaiveBayesMultinomial")
...
test_that("classif.NaiveBayesMultinomial predict", {
  # Here we test that the learner implements those arguments that are passed via the
  # control argument to RWeka::make_Weka_classifier('weka/classifiers/bayes/NaiveBayesMultinomial')
  learner = lrn("classif.NaiveBayesMultinomial")
