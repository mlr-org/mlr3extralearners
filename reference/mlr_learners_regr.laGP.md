...
#> [17,]  0    2   8 304.0 3.15    3 150 17.30  0 3.435
#> [18,]  0    4   8 350.0 3.73    3 245 15.41  0 3.840
#> [19,]  0    2   8 400.0 3.08    3 175 17.05  0 3.845
#> [20,]  1    1   4  79.0 4.08    4  66 18.90  1 1.935
#> [21,]  1    2   4 121.0 4.11    4 109 18.60  1 2.780
#> 
#> $z
#>  [1] 21.0 21.0 21.4 18.1 14.3 24.4 22.8 16.4 17.3 15.2 10.4 10.4 14.7 32.4 33.9
#> [16] 21.5 15.2 13.3 19.2 27.3 21.4
#> 

# Make predictions for the test rows
predictions = learner$predict(task, row_ids = ids$test)
#> i = 1 (of 11), d = 143781, its = 17
#> i = 2 (of 11), d = 12359, its = 5
#> i = 3 (of 11), d = 177618, its = 16
#> i = 4 (of 11), d = 177618, its = 16
#> i = 5 (of 11), d = 143781, its = 20
#> i = 6 (of 11), d = 180366, its = 38
#> i = 7 (of 11), d = 177618, its = 20
#> i = 8 (of 11), d = 143781, its = 21
#> i = 9 (of 11), d = 146539, its = 19
#> i = 10 (of 11), d = 143781, its = 20
#> i = 11 (of 11), d = 146538, its = 26
