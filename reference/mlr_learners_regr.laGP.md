...
#> [14,]  0    4   8 440.0 3.23    3 230 17.42  0 5.345
#> [15,]  1    1   4  78.7 4.08    4  66 19.47  1 2.200
#> [16,]  0    1   4 120.1 3.70    3  97 20.01  1 2.465
#> [17,]  0    2   8 318.0 2.76    3 150 16.87  0 3.520
#> [18,]  0    4   8 350.0 3.73    3 245 15.41  0 3.840
#> [19,]  1    1   4  79.0 4.08    4  66 18.90  1 1.935
#> [20,]  1    2   4  95.1 3.77    5 113 16.90  1 1.513
#> [21,]  1    8   8 301.0 3.54    5 335 14.60  0 3.570
#> 
#> $z
#>  [1] 21.0 21.0 22.8 21.4 18.7 18.1 14.3 22.8 17.8 16.4 17.3 15.2 10.4 14.7 32.4
#> [16] 21.5 15.5 13.3 27.3 30.4 15.0
#> 

# Make predictions for the test rows
predictions = learner$predict(task, row_ids = ids$test)
#> i = 1 (of 11), d = 122719, its = 17
#> i = 2 (of 11), d = 122719, its = 19
#> i = 3 (of 11), d = 167633, its = 38
#> i = 4 (of 11), d = 122719, its = 22
#> i = 5 (of 11), d = 122719, its = 15
#> i = 6 (of 11), d = 167633, its = 38
#> i = 7 (of 11), d = 167633, its = 38
#> i = 8 (of 11), d = 122719, its = 29
#> i = 9 (of 11), d = 167633, its = 38
#> i = 10 (of 11), d = 122719, its = 20
#> i = 11 (of 11), d = 122719, its = 16
