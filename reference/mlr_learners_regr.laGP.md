...
#> 
#> $z
#>  [1] 21.0 21.4 18.7 18.1 14.3 24.4 17.8 16.4 17.3 15.2 10.4 32.4 33.9 15.5 19.2
#> [16] 27.3 26.0 30.4 15.8 19.7 21.4
#> 

# Make predictions for the test rows
predictions = learner$predict(task, row_ids = ids$test)
#> i = 1 (of 11), d = 137946, its = 21
#> i = 2 (of 11), d = 173790, its = 38
#> i = 3 (of 11), d = 173790, its = 38
#> i = 4 (of 11), d = 137946, its = 18
#> i = 5 (of 11), d = 12102.2, its = 4
#> i = 6 (of 11), d = 12102.2, its = 4
#> i = 7 (of 11), d = 173790, its = 38
#> i = 8 (of 11), d = 173790, its = 38
#> i = 9 (of 11), d = 173790, its = 38
#> i = 10 (of 11), d = 173790, its = 38
