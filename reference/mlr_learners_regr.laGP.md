...
#>  [5,]  0    3   8 275.8 3.07    3 180 17.40  0 4.070
...
#> 
#> $z
#>  [1] 22.8 18.1 14.3 22.8 16.4 17.3 10.4 32.4 30.4 33.9 21.5 15.5 15.2 13.3 19.2
#> [16] 27.3 26.0 15.8 19.7 15.0 21.4
#> 

# Make predictions for the test rows
predictions = learner$predict(task, row_ids = ids$test)
#> i = 1 (of 11), d = 180503, its = 37
#> i = 2 (of 11), d = 180503, its = 37
#> i = 3 (of 11), d = 4484.76, its = 5
#> i = 4 (of 11), d = 23327, its = 6
#> i = 5 (of 11), d = 180503, its = 37
#> i = 6 (of 11), d = 180503, its = 37
#> i = 7 (of 11), d = 180503, its = 37
#> i = 8 (of 11), d = 26102.8, its = 7
#> i = 9 (of 11), d = 23327, its = 6
#> i = 10 (of 11), d = 23327, its = 6
