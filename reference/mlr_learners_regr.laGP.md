...
#> 
#> $z
#>  [1] 21.0 21.0 22.8 21.4 18.7 22.8 19.2 17.8 16.4 17.3 15.2 10.4 14.7 30.4 21.5
#> [16] 15.5 15.2 13.3 15.8 19.7 21.4
#> 

# Make predictions for the test rows
predictions = learner$predict(task, row_ids = ids$test)
#> i = 1 (of 11), d = 59386.4, its = 7
#> i = 2 (of 11), d = 180503, its = 38
#> i = 3 (of 11), d = 60369.6, its = 8
#> i = 4 (of 11), d = 180503, its = 38
#> i = 5 (of 11), d = 60369.6, its = 8
#> i = 6 (of 11), d = 60369.6, its = 8
#> i = 7 (of 11), d = 180503, its = 38
#> i = 8 (of 11), d = 60369.6, its = 8
#> i = 9 (of 11), d = 59592.6, its = 8
#> i = 10 (of 11), d = 59592.6, its = 8
