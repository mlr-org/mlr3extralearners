...
Classification tree with logistic regression models at the leaves. Calls
[`RWeka::LMT()`](https://rdrr.io/pkg/RWeka/man/Weka_classifier_trees.html)
...
- [`LearnerClassifLMT$unmarshal()`](#method-LearnerClassifLMT-unmarshal)

- [`LearnerClassifLMT$clone()`](#method-LearnerClassifLMT-clone)
