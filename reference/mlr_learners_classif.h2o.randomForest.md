...
#> Model ID:  DRF_model_R_1775288957974_58 
#> Model Summary: 
#>   number_of_trees number_of_internal_trees model_size_in_bytes min_depth
#> 1              50                       50               13242         5
#>   max_depth mean_depth min_leaves max_leaves mean_leaves
#> 1         9    6.84000         12         21    16.46000
#> 
#> 
...
#> RMSE:  0.3876231
#> LogLoss:  0.4527942
#> Mean Per-Class Error:  0.2434018
#> AUC:  0.8702346
#> AUCPR:  0.8568747
#> Gini:  0.7404692
#> R^2:  0.391912
...
#>         M  R    Error     Rate
#> M      42 35 0.454545   =35/77
#> R       2 60 0.032258    =2/62
#> Totals 44 95 0.266187  =37/139
#> 
#> Maximum Metrics: Maximum metrics at their respective thresholds
#>                         metric threshold     value idx
#> 1                       max f1  0.266667  0.764331  62
#> 2                       max f2  0.222222  0.878187  69
#> 3                 max f0point5  0.625000  0.785714  25
#> 4                 max accuracy  0.535714  0.776978  32
#> 5                max precision  1.000000  1.000000   0
#> 6                   max recall  0.222222  1.000000  69
#> 7              max specificity  1.000000  1.000000   0
#> 8             max absolute_mcc  0.535714  0.551786  32
#> 9   max min_per_class_accuracy  0.428571  0.758065  44
#> 10 max mean_per_class_accuracy  0.400000  0.766862  47
#> 11                     max tns  1.000000 77.000000   0
#> 12                     max fns  1.000000 58.000000   0
#> 13                     max fps  0.000000 77.000000  89
#> 14                     max tps  0.222222 62.000000  69
#> 15                     max tnr  1.000000  1.000000   0
#> 16                     max fnr  1.000000  0.935484   0
#> 17                     max fpr  0.000000  1.000000  89
#> 18                     max tpr  0.222222  1.000000  69
#> 
