...
#> Model ID:  DRF_model_R_1789486566152_58 
#> Model Summary: 
#>   number_of_trees number_of_internal_trees model_size_in_bytes min_depth
#> 1              50                       50               13080         5
#>   max_depth mean_depth min_leaves max_leaves mean_leaves
#> 1         8    6.58000         11         21    16.24000
#> 
#> 
...
#> RMSE:  0.3712554
#> LogLoss:  0.4283667
#> Mean Per-Class Error:  0.1878178
#> AUC:  0.8795551
#> AUCPR:  0.8784225
#> Gini:  0.7591102
#> R^2:  0.4357998
...
#> R      17 42 0.288136   =17/59
#> Totals 90 49 0.172662  =24/139
#> 
#> Maximum Metrics: Maximum metrics at their respective thresholds
#>                         metric threshold     value idx
#> 1                       max f1  0.480000  0.777778  34
#> 2                       max f2  0.200000  0.840456  72
#> 3                 max f0point5  0.578947  0.844749  29
#> 4                 max accuracy  0.480000  0.827338  34
#> 5                max precision  1.000000  1.000000   0
#> 6                   max recall  0.200000  1.000000  72
#> 7              max specificity  1.000000  1.000000   0
#> 8             max absolute_mcc  0.480000  0.645937  34
#> 9   max min_per_class_accuracy  0.416667  0.787500  44
#> 10 max mean_per_class_accuracy  0.480000  0.812182  34
#> 11                     max tns  1.000000 80.000000   0
#> 12                     max fns  1.000000 55.000000   0
#> 13                     max fps  0.000000 80.000000  88
#> 14                     max tps  0.200000 59.000000  72
#> 15                     max tnr  1.000000  1.000000   0
#> 16                     max fnr  1.000000  0.932203   0
#> 17                     max fpr  0.000000  1.000000  88
#> 18                     max tpr  0.200000  1.000000  72
#> 
