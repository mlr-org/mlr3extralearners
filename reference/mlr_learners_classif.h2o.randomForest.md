...
#> Model ID:  DRF_model_R_1775288230689_58 
#> Model Summary: 
#>   number_of_trees number_of_internal_trees model_size_in_bytes min_depth
#> 1              50                       50               12694         5
#>   max_depth mean_depth min_leaves max_leaves mean_leaves
#> 1         9    6.46000         11         21    15.60000
#> 
#> 
...
#> RMSE:  0.3617608
#> LogLoss:  0.4117983
#> Mean Per-Class Error:  0.1644793
#> AUC:  0.9100688
#> AUCPR:  0.88122
#> Gini:  0.8201377
#> R^2:  0.4559905
...
#>         M  R    Error     Rate
#> M      72 11 0.132530   =11/83
#> R      11 45 0.196429   =11/56
#> Totals 83 56 0.158273  =22/139
#> 
#> Maximum Metrics: Maximum metrics at their respective thresholds
#>                         metric threshold     value idx
#> 1                       max f1  0.444444  0.803571  37
#> 2                       max f2  0.277778  0.870968  51
#> 3                 max f0point5  0.521739  0.841346  26
#> 4                 max accuracy  0.444444  0.841727  37
#> 5                max precision  1.000000  1.000000   0
#> 6                   max recall  0.200000  1.000000  61
#> 7              max specificity  1.000000  1.000000   0
#> 8             max absolute_mcc  0.444444  0.671041  37
#> 9   max min_per_class_accuracy  0.421053  0.821429  39
#> 10 max mean_per_class_accuracy  0.444444  0.835521  37
#> 11                     max tns  1.000000 83.000000   0
#> 12                     max fns  1.000000 55.000000   0
#> 13                     max fps  0.000000 83.000000  81
#> 14                     max tps  0.200000 56.000000  61
#> 15                     max tnr  1.000000  1.000000   0
#> 16                     max fnr  1.000000  0.982143   0
#> 17                     max fpr  0.000000  1.000000  81
#> 18                     max tpr  0.200000  1.000000  61
#> 
