...
#> mpg = 
#> 
#>          3.6611 (normalized) am
#>  +      -4.9232 (normalized) carb
#>  +       2.0732 (normalized) cyl
#>  +       4.9435 (normalized) disp
#>  +       8.0476 (normalized) drat
#>  +       3.2757 (normalized) gear
#>  +      -3.076  (normalized) hp
#>  +       6.176  (normalized) qsec
#>  +       0.8273 (normalized) vs
#>  +      -4.2412 (normalized) wt
#>  +      13.9924
