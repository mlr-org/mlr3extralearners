...
#> 
#>          2.803  (normalized) am
#>  +      -2.5997 (normalized) carb
#>  +       1.9233 (normalized) cyl
#>  +       0.5616 (normalized) disp
#>  +       5.0659 (normalized) drat
#>  +       0.8889 (normalized) gear
#>  +      -3.4185 (normalized) hp
#>  +       7.5125 (normalized) qsec
#>  +      -1.4472 (normalized) vs
#>  +      -7.2717 (normalized) wt
#>  +      15.7768
