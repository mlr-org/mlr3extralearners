...
#> mpg = 
#> 
#>          3.3597 (normalized) am
#>  +      -2.7714 (normalized) carb
#>  +       3.5417 (normalized) cyl
#>  +      -2.5331 (normalized) disp
#>  +       0.9173 (normalized) drat
#>  +       1.3567 (normalized) gear
#>  +      -2.1548 (normalized) hp
#>  +       9.2305 (normalized) qsec
#>  +      -0.286  (normalized) vs
#>  +      -6.6286 (normalized) wt
#>  +      14.5186
