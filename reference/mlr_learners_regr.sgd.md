...
#> mpg = 
#> 
#>          7.4872 (normalized) am
#>  +      -5.4033 (normalized) carb
#>  +      -0.2422 (normalized) cyl
#>  +       0.109  (normalized) disp
#>  +       1.4434 (normalized) drat
#>  +      -0.5859 (normalized) gear
#>  +      -3.103  (normalized) hp
#>  +       6.1133 (normalized) qsec
#>  +       2.814  (normalized) vs
#>  +      -0.722  (normalized) wt
#>  +      16.3643
