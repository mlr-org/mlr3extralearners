...
#>  +       0.127  * (normalized) am
#>  -       0.062  * (normalized) carb
#>  -       0.13   * (normalized) cyl
#>  -       0.0046 * (normalized) disp
#>  +       0.026  * (normalized) drat
#>  -       0.0693 * (normalized) gear
#>  -       0.2164 * (normalized) hp
#>  +       0.0101 * (normalized) qsec
#>  +       0.052  * (normalized) vs
#>  -       0.3651 * (normalized) wt
#>  +       0.6964
#> 
#> 
#> 
#> Number of kernel evaluations: 231 (93.642% cached)
