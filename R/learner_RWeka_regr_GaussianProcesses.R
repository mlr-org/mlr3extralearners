...
#' Calls [RWeka::make_Weka_classifier('weka/classifiers/functions/GaussianProcesses')] from \CRANpkg{RWeka}.
#'
    ...
    initialize = function() {
      param_set = ps(
        ...
        E = p_dbl(default = 1.0, depends = (K == "weka.classifiers.functions.supportVector.PolyKernel"), 
                  tags = "train"),
        L = p_dbl(default = FALSE, depends = (K == "weka.classifiers.functions.supportVector.PolyKernel"), 
                  tags = "train"),
