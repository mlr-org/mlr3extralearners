...
# Passing a data frame instead of a numeric matrix does not change the predictions for tasks without
# categorical features, because tabpfn converts the data frame to a numeric array before any preprocessing.
