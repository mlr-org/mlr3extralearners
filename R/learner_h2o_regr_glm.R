  ...
  public = list(
    ...
    initialize = function() {
      param_set = ps(
        ...
        random_columns = p_uty(default = NULL, special_vals = list(NULL), depends = quote(HGLM == TRUE), tags = "train"),
        ...
        rand_family = p_uty(default = NULL, special_vals = list(NULL), depends = quote(HGLM == TRUE), tags = "train"),
        alpha = p_uty(default = NULL, special_vals = list(NULL), tags = "train"),
        lambda = p_uty(default = NULL, special_vals = list(NULL), tags = "train"),
        ...
        max_iterations = p_int(default = -1L, tags = "train"),
        ...
        rand_link = p_uty(default = NULL, special_vals = list(NULL), depends = quote(HGLM == TRUE), tags = "train"),
