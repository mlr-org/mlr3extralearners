#' @title Regression An Instance-based Learner Using An Entropic Distance Measure
#' @author damirpolat
...
#' Calls [RWeka::make_Weka_classifier()]{RWeka::make_Weka_classifier('weka/classifiers/lazy/KStar')} from \CRANpkg{RWeka}.
#'
...
#' @template example
#' @export
LearnerRegrKStar = R6Class("LearnerRegrKStar",
  inherit = LearnerRegr,
  public = list(
    #' @description
