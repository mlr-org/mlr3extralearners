...
#' Calls `survivalmodelsmlr3::parametric()` from package 'survivalmodelsmlr3'.
#'
...
#'
#' The predict method is implemented in `survivalmodelsmlr3::predict.parametric()`.
