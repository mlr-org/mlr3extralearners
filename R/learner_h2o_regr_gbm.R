  ...
  public = list(
    ...
    initialize = function() {
      param_set = ps(
        ...
        distribution = p_fct(default = "gaussian", levels = c("poisson", "laplace", "tweedie", "gaussian", "huber", "gamma", "quantile", "custom"), tags = "train"),
        ...
        categorical_encoding = p_fct(default = "AUTO", levels = c("AUTO", "Enum", "OneHotInternal", "OneHotExplicit", "Binary", "Eigen", "LabelEncoder", "SortByResponse"), tags = "train"),
        min_split_improvement = p_dbl(default = 1e-05, lower = 0, tags = "train"),
        histogram_type = p_fct(default = "AUTO", levels = c("AUTO", "UniformAdaptive", "Random", "QuantilesGlobal", "RoundRobin"), tags = "train"),
        ...
        stopping_metric = p_fct(default = "AUTO", levels = c("AUTO", "deviance", "MSE", "RMSE", "MAE", "RMSLE", "custom", "custom_increasing"), tags = "train"),
