...
#'
#' @references
#' Junxian Zhu, Canhong Wen, Jin Zhu, Heping Zhang, and Xueqin Wang (2020).
...
#' J. Mach. Learn. Res., 21(212), 1-6.
#'
#' Yanhang Zhang, Junxian Zhu, Jin Zhu, and Xueqin Wang (2021).
#' "Certifiably Polynomial Algorithm for Best Group Subset Selection."
#' arXiv preprint arXiv:2104.12576.
#'
#' Qiang Sun and Heping Zhang (2020).
