          ...
          public = list(
            ...
            initialize = function() {
              ps = ps(
                ...
                n_tree = p_int(default = 500L,
                               lower = 1L,
                               tags = 'train'),

                n_split = p_int(default = 5L,
                                lower = 1L,
                                tags = 'train'),

                n_retry = p_int(default = 3L,
                                lower = 0L,
                                tags = 'train'),
                ...
                control_fast_do_scale = p_lgl(default = TRUE,
                                              tags = "train"),
                ...
                control_cph_eps = p_dbl(default = 1e-9,
                                        lower = 0,
                                        tags = "train"),

                control_cph_iter_max = p_int(default = 20L,
                                             lower = 1,
                                             tags = "train"),

                control_net_alpha = p_dbl(default = 0.5,
                                          tags = "train"),

                control_net_df_target = p_int(lower = 1L,
                                              tags = 'train'),

                mtry_ratio = p_dbl(lower = 0,
                                   upper = 1,
                                   tags = "train"),

                leaf_min_events = p_int(default = 1L,
                                        lower = 1L,
                                        tags = 'train'),

                leaf_min_obs = p_int(default = 5L,
                                     lower = 1L,
                                     tags = 'train'),

                split_min_events = p_int(default = 5L,
                                         lower = 1L,
                                         tags = 'train'),

                split_min_obs = p_int(default = 10,
                                      lower = 1L,
                                      tags = 'train'),

                split_min_stat = p_dbl(default = 3.841459,
                                       lower = 0,
                                       tags = 'train'),

                oobag_pred_type = p_fct(levels = c("none",
                                                   "surv",
                                                   "risk",
                                                   "chf"),
                                        default = "surv",
                ...
                importance = p_fct(levels = c("none",
                                              "anova",
                                              "negate",
                                              "permute"),
                                   default = "anova",
                ...
                oobag_eval_every = p_int(lower = 1,
                                         tags = "train"),
