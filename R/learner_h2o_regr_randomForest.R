  ...
  public = list(
    ...
    initialize = function() {
      param_set = ps(
        ...
        calibration_method = p_fct(levels = c("AUTO", "PlattScaling", "IsotonicRegression"), default = "AUTO", depends = quote(calibrate_model == TRUE), tags = "train"),
        distribution = p_fct(levels = c("AUTO", "gaussian", "poisson"), default = "AUTO", tags = "train"),
