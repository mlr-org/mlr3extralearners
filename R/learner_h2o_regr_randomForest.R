  ...
  public = list(
    ...
    initialize = function() {
      param_set = ps(
        ...
        checkpoint = p_uty(default = NULL, special_vals = list(NULL), tags = "train", custom_check = check_string),
        ...
        export_checkpoints_dir = p_uty(default = NULL, special_vals = list(NULL), tags = "train", custom_check = check_string),
