...
#'
#' @references
#' `r format_bib("Freund1998")`
#'
#' @template seealso_learner
#' @template example
#' @export
LearnerClassifVotedPerceptron = R6Class("LearnerClassifVotedPerceptron",
  ...
  public = list(
    ...
    initialize = function() {
      param_set = ps(
        ...
        E = p_dbl(default = 1L, tags = "train"),
        S = p_int(default = 1L, tags = "train"),
        M = p_int(default = 10000L, tags = "train"),
  ...
  private = list(
    .train = function(task) {
      weka_learner = RWeka::make_Weka_classifier("weka/classifiers/functions/VotedPerceptron")
