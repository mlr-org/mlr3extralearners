...
#' - `importance` allows to choose the type of importance. Default is `count`, see `importance()` for more details.
...
delayedAssign(
  "LearnerSurvLearnerSurvBART", R6Class("LearnerSurvLearnerSurvBART",
    ...
    public = list(
      ...
      #' @description
      #' Two types of importance scores are supported based on the initial value
      ...
      #' 2. `count`: The observed count of each feature in the trees, extracted
      #' from the slot `varcount.mean`.
