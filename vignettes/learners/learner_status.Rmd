...
tbl[,Status := ifelse(mlr3_package == "mlr3extralearners",
  paste0("[![", Package, "](https://github.com/mlr-org/mlr3extralearners/actions/workflows/test_", Package, ".yml/badge.svg)](https://github.com/mlr-org/mlr3extralearners/actions/workflows/test_", Package, ".yml)"),
