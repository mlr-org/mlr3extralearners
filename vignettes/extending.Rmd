...
For the first two properties, see the [documentation of `?Learner`](https://mlr3.mlr-org.com/reference/Learner.html) or the implementations for the [`XGBoost` learners](https://github.com/mlr-org/mlr3learners/blob/main/R/LearnerClassifXgboost.R).
The documentation on marshaling can be found by running `?marshaling`, and example implementations can be found in [`mlr3torch`](https://github.com/mlr-org/mlr3torch/blob/main/R/LearnerTorch.R).
