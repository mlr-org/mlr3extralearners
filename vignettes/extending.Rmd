...
# row ids with am == 1
row_ids_am_1 = task$row_ids[task$data(cols = "am")[["am"]] == 1L]
...
# weighted learner
learner = LearnerRegrRpartSimple$new()
pred2 = learner$train(task_wt)$predict(task_wt)

pred2$filter(row_ids_am_1)$score(msr("regr.mse"))

```

Based on the Mean Squared Error for the subset of cars having `am == 1` it becomes evident, that the weighted learner focuses more on minimizing the error for those observations than for the others.
