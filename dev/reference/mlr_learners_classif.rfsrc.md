...
#>        Average no. of terminal nodes: 17.256
...
#>                    (OOB) Brier score: 0.13796925
#>         (OOB) Normalized Brier score: 0.55187699
#>                            (OOB) AUC: 0.92694064
#>                       (OOB) Log-loss: 0.44061926
#>                         (OOB) PR-AUC: 0.91957958
#>                         (OOB) G-mean: 0.79381168
#>    (OOB) Requested performance error: 0.1942446, 0.09589041, 0.3030303
#> 
#> Confusion matrix:
#> 
#>           predicted
...
#>           V12           V11            V9           V51           V10 
#>  0.0739819306  0.0648084011  0.0381324263  0.0325314953  0.0265220876 
#>           V36           V45           V13           V37           V34 
#>  0.0264917018  0.0238648047  0.0216705294  0.0193143499  0.0166146331 
#>           V21           V52           V58           V30           V16 
#>  0.0163007470  0.0161950216  0.0155843564  0.0135446626  0.0130991654 
#>           V17            V6           V49           V59           V43 
#>  0.0130805316  0.0122000997  0.0119433690  0.0119370934  0.0110511681 
#>           V32            V1           V44           V47           V18 
#>  0.0108559944  0.0104525160  0.0102214832  0.0101846177  0.0097442239 
#>           V28           V48           V40            V3           V23 
#>  0.0096202668  0.0094388200  0.0091766309  0.0091557482  0.0087130847 
#>           V39            V8           V31           V14           V41 
#>  0.0085676672  0.0084506950  0.0083301482  0.0082948711  0.0076886749 
#>           V15           V54            V2           V46            V7 
#>  0.0075822488  0.0068626404  0.0068151344  0.0068000927  0.0065662171 
#>           V20            V4           V53            V5           V26 
#>  0.0065460403  0.0064284104  0.0059675205  0.0055253386  0.0055182089 
#>           V22           V42           V55           V27           V25 
#>  0.0054909217  0.0049448930  0.0046395628  0.0044974195  0.0043426572 
#>           V38           V35           V19           V29           V56 
#>  0.0040783015  0.0036363641  0.0033473684  0.0030403503  0.0029018156 
#>           V24           V50           V57           V33           V60 
#>  0.0023190450  0.0020502828  0.0017595947  0.0015837000 -0.0005789542 
