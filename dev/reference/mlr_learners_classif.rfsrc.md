...
print(learner$model)
#>                          Sample size: 139
#>            Frequency of class labels: M=84, R=55
#>                      Number of trees: 500
#>            Forest terminal node size: 1
#>        Average no. of terminal nodes: 16.838
...
#>                     Imbalanced ratio: 1.5273
#>                    (OOB) Brier score: 0.13613093
#>         (OOB) Normalized Brier score: 0.54452371
#>                            (OOB) AUC: 0.9047619
#>                       (OOB) Log-loss: 0.4293881
#>                         (OOB) PR-AUC: 0.87550843
#>                         (OOB) G-mean: 0.75764502
#>    (OOB) Requested performance error: 0.1942446, 0.07142857, 0.38181818
#> 
#> Confusion matrix:
#> 
#>           predicted
...
#>          V12          V11          V36           V9          V37          V48 
#> 0.0707107613 0.0638330277 0.0427544311 0.0425765666 0.0324337937 0.0280221040 
#>          V10          V18          V17          V13          V46           V4 
#> 0.0275002719 0.0209502199 0.0199064013 0.0190923636 0.0184443677 0.0175837795 
#>          V47          V49          V30          V32          V16          V45 
#> 0.0173182918 0.0171062267 0.0170008176 0.0168848150 0.0166043421 0.0164425787 
#>          V15          V21          V19          V35          V52           V8 
#> 0.0146775768 0.0141048706 0.0130623573 0.0126452476 0.0125483501 0.0119618734 
#>          V14          V20           V1          V28          V42          V29 
#> 0.0119110590 0.0109227071 0.0109136348 0.0108912461 0.0101897908 0.0099285177 
#>          V39           V7          V31          V22          V27          V25 
#> 0.0098721955 0.0094419873 0.0091773834 0.0084455277 0.0082918883 0.0078266691 
#>          V38          V34          V54           V3          V43          V40 
#> 0.0070826803 0.0070228112 0.0067029155 0.0066882414 0.0065444505 0.0058060406 
#>           V6          V51           V5          V44          V26          V53 
#> 0.0055064314 0.0050864315 0.0048174577 0.0043969097 0.0041124227 0.0037853496 
#>           V2          V58          V57          V55          V41          V24 
#> 0.0033576964 0.0026551991 0.0026267900 0.0024775982 0.0023338689 0.0021986184 
#>          V33          V60          V23          V50          V56          V59 
#> 0.0015901713 0.0015878229 0.0010297527 0.0010091699 0.0008938667 0.0007300034 
