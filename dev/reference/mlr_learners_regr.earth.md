...
Regression Splines). MARS is trademarked and thus not used as the name.
The name "earth" stands for "Enhanced Adaptive Regression Through
Hinges".

Calls [`earth::earth()`](https://rdrr.io/pkg/earth/man/earth.html) from
...
print(learner$model)
#> Selected 3 of 8 terms, and 2 of 10 predictors
#> Termination condition: GRSq -10 at 8 terms
#> Importance: disp, carb, am-unused, cyl-unused, drat-unused, gear-unused, ...
#> Number of terms at each degree of interaction: 1 2 (additive model)
#> GCV 8.984128    RSS 109.5208    GRSq 0.7300377    RSq 0.8272242
