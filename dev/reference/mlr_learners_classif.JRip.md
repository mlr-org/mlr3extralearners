...
Repeated Incremental Pruning to Produce Error Reduction. Calls
...
Cohen, W W (1995). “Fast effective rule induction.” In *Machine learning
proceedings 1995*, 115–123. Elsevier.
...
- [`LearnerClassifJRip$unmarshal()`](#method-LearnerClassifJRip-unmarshal)

- [`LearnerClassifJRip$clone()`](#method-LearnerClassifJRip-clone)
