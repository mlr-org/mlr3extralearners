...
Class for constructing a random forest. Calls
...
- [`LearnerClassifRandomForestWeka$unmarshal()`](#method-LearnerClassifRandomForestWeka-unmarshal)

- [`LearnerClassifRandomForestWeka$clone()`](#method-LearnerClassifRandomForestWeka-clone)
