...
Bayesian version of the support vector machine. Parameters `sigma`,
`degree`, `scale`, `offset`, `order`, `length`, `lambda`, and
...
then the default "automatic" is used for `kpar`. Calls
[`kernlab::rvm()`](https://rdrr.io/pkg/kernlab/man/rvm.html) from
...
#>  Hyperparameter : sigma =  0.000902015631999689 
#> 
#> Number of Relevance Vectors : 11 
#> Variance :  44.61741
#> Training error : 25.656700923 
