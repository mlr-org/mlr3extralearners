...
Bergmeir, Christoph, Benitez, M. J (2023). “RSNNS: Neural Networks using
...
-\> `LearnerClassifMLPRsnns`

## Methods

### Public methods

- [`LearnerClassifMLPRsnns$new()`](#method-LearnerClassifMLPRsnns-initialize)

- [`LearnerClassifMLPRsnns$clone()`](#method-LearnerClassifMLPRsnns-clone)
...
### `LearnerClassifMLPRsnns$clone()`

The objects of this class are cloneable with this method.

#### Usage

    LearnerClassifMLPRsnns$clone(deep = FALSE)
...
print(learner)
#> 
#> ── <LearnerClassifMLPRsnns> (classif.mlp_rsnns): Multi-Layer Perceptron ────────
#> • Model: -
#> • Parameters: list()
