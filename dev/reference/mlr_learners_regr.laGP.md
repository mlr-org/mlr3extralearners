...
#>  [4,]  0    3   8 275.8 3.07    3 180 17.40  0 4.070
#>  [5,]  0    3   8 275.8 3.07    3 180 18.00  0 3.780
#>  [6,]  0    4   8 472.0 2.93    3 205 17.98  0 5.250
#>  [7,]  0    4   8 460.0 3.00    3 215 17.82  0 5.424
#>  [8,]  1    1   4  78.7 4.08    4  66 19.47  1 2.200
#>  [9,]  1    2   4  75.7 4.93    4  52 18.52  1 1.615
#> [10,]  1    1   4  71.1 4.22    4  65 19.90  1 1.835
#> [11,]  0    1   4 120.1 3.70    3  97 20.01  1 2.465
#> [12,]  0    2   8 304.0 3.15    3 150 17.30  0 3.435
#> [13,]  0    4   8 350.0 3.73    3 245 15.41  0 3.840
#> [14,]  0    2   8 400.0 3.08    3 175 17.05  0 3.845
#> [15,]  1    1   4  79.0 4.08    4  66 18.90  1 1.935
...
#> 
#> $z
#>  [1] 21.0 18.1 14.3 16.4 15.2 10.4 10.4 32.4 30.4 33.9 21.5 15.2 13.3 19.2 27.3
#> [16] 26.0 30.4 15.8 19.7 15.0 21.4
#> 

# Make predictions for the test rows
predictions = learner$predict(task, row_ids = ids$test)
#> i = 1 (of 11), d = 142298, its = 20
#> i = 2 (of 11), d = 142298, its = 16
#> i = 3 (of 11), d = 42421.8, its = 8
#> i = 4 (of 11), d = 26550.8, its = 6
#> i = 5 (of 11), d = 142297, its = 18
#> i = 6 (of 11), d = 142298, its = 34
#> i = 7 (of 11), d = 180503, its = 39
#> i = 8 (of 11), d = 180503, its = 39
#> i = 9 (of 11), d = 28355.1, its = 5
#> i = 10 (of 11), d = 24681.7, its = 5
#> i = 11 (of 11), d = 26550.8, its = 6
