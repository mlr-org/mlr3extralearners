...
#> 
#> $z
#>  [1] 21.0 21.0 22.8 21.4 18.7 14.3 24.4 19.2 17.8 17.3 10.4 14.7 33.9 21.5 15.5
#> [16] 13.3 27.3 30.4 15.8 19.7 21.4
#> 

# Make predictions for the test rows
predictions = learner$predict(task, row_ids = ids$test)
#> i = 1 (of 11), d = 18023.4, its = 6
#> i = 2 (of 11), d = 18023.4, its = 6
#> i = 3 (of 11), d = 173790, its = 38
#> i = 4 (of 11), d = 173790, its = 38
#> i = 5 (of 11), d = 12246.7, its = 5
#> i = 6 (of 11), d = 18023.4, its = 6
#> i = 7 (of 11), d = 18023.4, its = 6
#> i = 8 (of 11), d = 11620.9, its = 6
#> i = 9 (of 11), d = 11620.9, its = 6
#> i = 10 (of 11), d = 18023.4, its = 6
#> i = 11 (of 11), d = 11620.9, its = 6
