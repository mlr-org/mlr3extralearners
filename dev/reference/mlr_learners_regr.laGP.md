...
#> [17,]  0    1   4 120.1 3.70    3  97 20.01  1 2.465
#> [18,]  0    2   8 318.0 2.76    3 150 16.87  0 3.520
#> [19,]  1    1   4  79.0 4.08    4  66 18.90  1 1.935
#> [20,]  1    2   4 120.3 4.43    5  91 16.70  0 2.140
#> [21,]  1    6   6 145.0 3.62    5 175 15.50  0 2.770
#> 
#> $z
#>  [1] 21.0 21.0 22.8 21.4 18.7 18.1 24.4 22.8 19.2 17.3 10.4 10.4 14.7 32.4 30.4
#> [16] 33.9 21.5 15.5 27.3 26.0 19.7
#> 

# Make predictions for the test rows
predictions = learner$predict(task, row_ids = ids$test)
#> i = 1 (of 11), d = 8876.74, its = 6
#> i = 2 (of 11), d = 177359, its = 28
#> i = 3 (of 11), d = 8886.58, its = 5
#> i = 4 (of 11), d = 8886.58, its = 5
#> i = 5 (of 11), d = 8886.58, its = 5
#> i = 6 (of 11), d = 8876.74, its = 6
#> i = 7 (of 11), d = 8876.74, its = 6
#> i = 8 (of 11), d = 177359, its = 24
#> i = 9 (of 11), d = 8876.74, its = 6
#> i = 10 (of 11), d = 9047.53, its = 6
#> i = 11 (of 11), d = 177359, its = 19
