...
#> 
#> $z
#>  [1] 21.0 21.0 22.8 18.1 24.4 19.2 17.8 16.4 17.3 15.2 10.4 10.4 32.4 30.4 33.9
#> [16] 21.5 19.2 27.3 26.0 19.7 15.0
#> 

# Make predictions for the test rows
predictions = learner$predict(task, row_ids = ids$test)
#> i = 1 (of 11), d = 180503, its = 39
#> i = 2 (of 11), d = 180503, its = 37
#> i = 3 (of 11), d = 126910, its = 15
#> i = 4 (of 11), d = 180503, its = 38
#> i = 5 (of 11), d = 126910, its = 20
#> i = 6 (of 11), d = 127562, its = 7
#> i = 7 (of 11), d = 129520, its = 20
#> i = 8 (of 11), d = 126910, its = 15
#> i = 9 (of 11), d = 180503, its = 38
#> i = 10 (of 11), d = 126910, its = 15
