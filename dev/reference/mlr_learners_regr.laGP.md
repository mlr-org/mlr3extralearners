...
#> [12,]  0    3   8 275.8 3.07    3 180 18.00  0 3.780
#> [13,]  0    4   8 472.0 2.93    3 205 17.98  0 5.250
#> [14,]  1    1   4  78.7 4.08    4  66 19.47  1 2.200
#> [15,]  1    1   4  71.1 4.22    4  65 19.90  1 1.835
#> [16,]  0    1   4 120.1 3.70    3  97 20.01  1 2.465
#> [17,]  0    2   8 318.0 2.76    3 150 16.87  0 3.520
#> [18,]  0    2   8 304.0 3.15    3 150 17.30  0 3.435
#> [19,]  1    2   4 120.3 4.43    5  91 16.70  0 2.140
#> [20,]  1    2   4  95.1 3.77    5 113 16.90  1 1.513
#> [21,]  1    2   4 121.0 4.11    4 109 18.60  1 2.780
#> 
#> $z
#>  [1] 21.0 22.8 21.4 18.7 18.1 14.3 24.4 22.8 17.8 16.4 17.3 15.2 10.4 32.4 33.9
#> [16] 21.5 15.5 15.2 26.0 30.4 21.4
#> 

# Make predictions for the test rows
predictions = learner$predict(task, row_ids = ids$test)
#> i = 1 (of 11), d = 3605.74, its = 6
#> i = 2 (of 11), d = 3605.74, its = 6
#> i = 3 (of 11), d = 180366, its = 38
#> i = 4 (of 11), d = 180366, its = 38
#> i = 5 (of 11), d = 3605.74, its = 6
#> i = 6 (of 11), d = 180366, its = 38
#> i = 7 (of 11), d = 180366, its = 38
#> i = 8 (of 11), d = 3605.74, its = 6
#> i = 9 (of 11), d = 180366, its = 38
#> i = 10 (of 11), d = 3605.74, its = 6
#> i = 11 (of 11), d = 180366, its = 38
