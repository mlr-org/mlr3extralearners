...
- [`LearnerRegrLaGP$new()`](#method-LearnerRegrLaGP-initialize)
...
#>  [3,]  0    2   4 146.7 3.69    4  62 20.00  1 3.190
#>  [4,]  0    2   4 140.8 3.92    4  95 22.90  1 3.150
#>  [5,]  0    4   6 167.6 3.92    4 123 18.90  1 3.440
#>  [6,]  0    3   8 275.8 3.07    3 180 17.40  0 4.070
#>  [7,]  0    3   8 275.8 3.07    3 180 17.60  0 3.730
#>  [8,]  0    3   8 275.8 3.07    3 180 18.00  0 3.780
#>  [9,]  0    4   8 460.0 3.00    3 215 17.82  0 5.424
#> [10,]  0    4   8 440.0 3.23    3 230 17.42  0 5.345
...
#> 
#> $z
#>  [1] 21.0 18.1 24.4 22.8 17.8 16.4 17.3 15.2 10.4 14.7 32.4 30.4 33.9 15.5 15.2
#> [16] 19.2 27.3 26.0 15.8 19.7 21.4
#> 

# Make predictions for the test rows
predictions = learner$predict(task, row_ids = ids$test)
#> i = 1 (of 11), d = 174297, its = 38
#> i = 2 (of 11), d = 174297, its = 38
#> i = 3 (of 11), d = 8738.54, its = 5
#> i = 4 (of 11), d = 83721.6, its = 20
#> i = 5 (of 11), d = 46603.2, its = 21
#> i = 6 (of 11), d = 174297, its = 38
#> i = 7 (of 11), d = 83721.6, its = 18
#> i = 8 (of 11), d = 174297, its = 38
#> i = 9 (of 11), d = 50806, its = 20
#> i = 10 (of 11), d = 174297, its = 37
#> i = 11 (of 11), d = 47613.9, its = 23
