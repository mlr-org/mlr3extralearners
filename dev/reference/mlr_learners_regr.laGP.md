...
#>  [2,]  0    4   8 360.0 3.21    3 245 15.84  0 3.570
#>  [3,]  0    2   4 140.8 3.92    4  95 22.90  1 3.150
#>  [4,]  0    4   6 167.6 3.92    4 123 18.90  1 3.440
#>  [5,]  0    3   8 275.8 3.07    3 180 17.60  0 3.730
#>  [6,]  0    3   8 275.8 3.07    3 180 18.00  0 3.780
#>  [7,]  0    4   8 472.0 2.93    3 205 17.98  0 5.250
#>  [8,]  0    4   8 460.0 3.00    3 215 17.82  0 5.424
#>  [9,]  1    1   4  78.7 4.08    4  66 19.47  1 2.200
...
#> 
#> $z
#>  [1] 21.0 14.3 22.8 17.8 17.3 15.2 10.4 10.4 32.4 30.4 21.5 15.5 15.2 13.3 19.2
#> [16] 27.3 26.0 30.4 19.7 15.0 21.4
#> 

# Make predictions for the test rows
predictions = learner$predict(task, row_ids = ids$test)
#> i = 1 (of 11), d = 169078, its = 21
#> i = 2 (of 11), d = 169078, its = 17
#> i = 3 (of 11), d = 49946.3, its = 5
#> i = 4 (of 11), d = 173926, its = 30
#> i = 5 (of 11), d = 169078, its = 21
#> i = 6 (of 11), d = 169078, its = 20
#> i = 7 (of 11), d = 169078, its = 17
#> i = 8 (of 11), d = 87076.3, its = 24
#> i = 9 (of 11), d = 88619.1, its = 18
#> i = 10 (of 11), d = 169078, its = 19
#> i = 11 (of 11), d = 173926, its = 21
