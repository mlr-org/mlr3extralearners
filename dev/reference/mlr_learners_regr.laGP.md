...
#>  [4,]  0    4   6 167.6 3.92    4 123 18.30  1 3.440
#>  [5,]  0    4   6 167.6 3.92    4 123 18.90  1 3.440
#>  [6,]  0    3   8 275.8 3.07    3 180 17.40  0 4.070
#>  [7,]  0    3   8 275.8 3.07    3 180 18.00  0 3.780
...
#> 
#> $z
#>  [1] 21.0 21.4 14.3 19.2 17.8 16.4 15.2 10.4 10.4 32.4 30.4 33.9 15.5 13.3 27.3
#> [16] 26.0 30.4 15.8 19.7 15.0 21.4
#> 

# Make predictions for the test rows
predictions = learner$predict(task, row_ids = ids$test)
#> i = 1 (of 11), d = 119602, its = 18
#> i = 2 (of 11), d = 119602, its = 18
#> i = 3 (of 11), d = 66881.6, its = 6
#> i = 4 (of 11), d = 119602, its = 17
#> i = 5 (of 11), d = 119602, its = 19
#> i = 6 (of 11), d = 119602, its = 20
#> i = 7 (of 11), d = 67504.6, its = 5
#> i = 8 (of 11), d = 57713.2, its = 5
#> i = 9 (of 11), d = 119602, its = 23
#> i = 10 (of 11), d = 3715.81, its = 2
#> i = 11 (of 11), d = 69808.2, its = 6
