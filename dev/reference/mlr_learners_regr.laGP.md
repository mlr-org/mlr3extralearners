...
#> 
#> $z
#>  [1] 21.0 21.4 18.1 14.3 24.4 22.8 16.4 17.3 15.2 10.4 10.4 14.7 33.9 21.5 15.5
#> [16] 13.3 19.2 26.0 30.4 19.7 21.4
#> 

# Make predictions for the test rows
predictions = learner$predict(task, row_ids = ids$test)
#> i = 1 (of 11), d = 7858.75, its = 6
#> i = 2 (of 11), d = 7858.75, its = 6
#> i = 3 (of 11), d = 180366, its = 38
#> i = 4 (of 11), d = 7858.75, its = 6
#> i = 5 (of 11), d = 7858.75, its = 6
#> i = 6 (of 11), d = 7858.75, its = 6
#> i = 7 (of 11), d = 7858.75, its = 6
#> i = 8 (of 11), d = 180366, its = 38
#> i = 9 (of 11), d = 7858.75, its = 6
