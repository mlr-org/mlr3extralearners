...
#> [14,]  0    4   8 460.0 3.00    3 215 17.82  0 5.424
#> [15,]  1    1   4  78.7 4.08    4  66 19.47  1 2.200
#> [16,]  1    2   4  75.7 4.93    4  52 18.52  1 1.615
#> [17,]  1    1   4  71.1 4.22    4  65 19.90  1 1.835
...
#> 
#> $z
#>  [1] 21.0 21.0 22.8 18.7 18.1 24.4 22.8 19.2 17.8 16.4 17.3 15.2 10.4 10.4 32.4
#> [16] 30.4 33.9 13.3 15.8 19.7 21.4
#> 

# Make predictions for the test rows
predictions = learner$predict(task, row_ids = ids$test)
#> i = 1 (of 11), d = 160352, its = 7
#> i = 2 (of 11), d = 143241, its = 15
#> i = 3 (of 11), d = 143242, its = 20
#> i = 4 (of 11), d = 41610.3, its = 6
#> i = 5 (of 11), d = 147507, its = 24
#> i = 6 (of 11), d = 156733, its = 18
#> i = 7 (of 11), d = 143242, its = 32
#> i = 8 (of 11), d = 41610.3, its = 6
#> i = 9 (of 11), d = 41610.3, its = 6
#> i = 10 (of 11), d = 41610.3, its = 6
#> i = 11 (of 11), d = 143241, its = 19
