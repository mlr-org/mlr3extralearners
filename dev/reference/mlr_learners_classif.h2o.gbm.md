...
#> Model ID:  GBM_model_R_1784031523981_4 
#> Model Summary: 
#>   number_of_trees number_of_internal_trees model_size_in_bytes min_depth
#> 1              50                       50                9287         4
#>   max_depth mean_depth min_leaves max_leaves mean_leaves
#> 1         5    4.94000          8         12    10.16000
#> 
#> 
...
#> 1                       max f1  0.912968  1.000000  62
#> 2                       max f2  0.912968  1.000000  62
#> 3                 max f0point5  0.912968  1.000000  62
#> 4                 max accuracy  0.912968  1.000000  62
#> 5                max precision  0.992542  1.000000   0
#> 6                   max recall  0.912968  1.000000  62
#> 7              max specificity  0.992542  1.000000   0
#> 8             max absolute_mcc  0.912968  1.000000  62
#> 9   max min_per_class_accuracy  0.912968  1.000000  62
#> 10 max mean_per_class_accuracy  0.912968  1.000000  62
#> 11                     max tns  0.992542 76.000000   0
#> 12                     max fns  0.992542 62.000000   0
#> 13                     max fps  0.004024 76.000000 138
#> 14                     max tps  0.912968 63.000000  62
#> 15                     max tnr  0.992542  1.000000   0
#> 16                     max fnr  0.992542  0.984127   0
#> 17                     max fpr  0.004024  1.000000 138
#> 18                     max tpr  0.912968  1.000000  62
#> 
