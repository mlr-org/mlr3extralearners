...
#> Model ID:  GBM_model_R_1789485937022_4 
#> Model Summary: 
#>   number_of_trees number_of_internal_trees model_size_in_bytes min_depth
#> 1              50                       50                9639         4
#>   max_depth mean_depth min_leaves max_leaves mean_leaves
#> 1         5    4.90000          8         12    10.70000
#> 
#> 
...
#> 1                       max f1  0.917169  1.000000  61
#> 2                       max f2  0.917169  1.000000  61
#> 3                 max f0point5  0.917169  1.000000  61
#> 4                 max accuracy  0.917169  1.000000  61
#> 5                max precision  0.991314  1.000000   0
#> 6                   max recall  0.917169  1.000000  61
#> 7              max specificity  0.991314  1.000000   0
#> 8             max absolute_mcc  0.917169  1.000000  61
#> 9   max min_per_class_accuracy  0.917169  1.000000  61
#> 10 max mean_per_class_accuracy  0.917169  1.000000  61
#> 11                     max tns  0.991314 77.000000   0
#> 12                     max fns  0.991314 61.000000   0
#> 13                     max fps  0.007679 77.000000 138
#> 14                     max tps  0.917169 62.000000  61
#> 15                     max tnr  0.991314  1.000000   0
#> 16                     max fnr  0.991314  0.983871   0
#> 17                     max fpr  0.007679  1.000000 138
#> 18                     max tpr  0.917169  1.000000  61
#> 
