...
#> Model ID:  GBM_model_R_1789483589516_5 
#> Model Summary: 
#>   number_of_trees number_of_internal_trees model_size_in_bytes min_depth
#> 1              50                       50                9315         4
#>   max_depth mean_depth min_leaves max_leaves mean_leaves
#> 1         5    4.94000          8         12    10.18000
#> 
#> 
...
#>         M  R    Error    Rate
#> M      83  0 0.000000   =0/83
#> R       0 56 0.000000   =0/56
#> Totals 83 56 0.000000  =0/139
#> 
#> Maximum Metrics: Maximum metrics at their respective thresholds
#>                         metric threshold     value idx
#> 1                       max f1  0.894818  1.000000  55
#> 2                       max f2  0.894818  1.000000  55
#> 3                 max f0point5  0.894818  1.000000  55
#> 4                 max accuracy  0.894818  1.000000  55
#> 5                max precision  0.991898  1.000000   0
#> 6                   max recall  0.894818  1.000000  55
#> 7              max specificity  0.991898  1.000000   0
#> 8             max absolute_mcc  0.894818  1.000000  55
#> 9   max min_per_class_accuracy  0.894818  1.000000  55
#> 10 max mean_per_class_accuracy  0.894818  1.000000  55
#> 11                     max tns  0.991898 83.000000   0
#> 12                     max fns  0.991898 55.000000   0
#> 13                     max fps  0.004138 83.000000 138
#> 14                     max tps  0.894818 56.000000  55
#> 15                     max tnr  0.991898  1.000000   0
#> 16                     max fnr  0.991898  0.982143   0
#> 17                     max fpr  0.004138  1.000000 138
#> 18                     max tpr  0.894818  1.000000  55
#> 
