...
#> Model ID:  GBM_model_R_1782414500988_5 
#> Model Summary: 
#>   number_of_trees number_of_internal_trees model_size_in_bytes min_depth
#> 1              50                       50                9533         4
#>   max_depth mean_depth min_leaves max_leaves mean_leaves
#> 1         5    4.96000          8         12    10.52000
#> 
#> 
...
#> 1                       max f1  0.923303  1.000000  64
#> 2                       max f2  0.923303  1.000000  64
#> 3                 max f0point5  0.923303  1.000000  64
#> 4                 max accuracy  0.923303  1.000000  64
#> 5                max precision  0.991789  1.000000   0
#> 6                   max recall  0.923303  1.000000  64
#> 7              max specificity  0.991789  1.000000   0
#> 8             max absolute_mcc  0.923303  1.000000  64
#> 9   max min_per_class_accuracy  0.923303  1.000000  64
#> 10 max mean_per_class_accuracy  0.923303  1.000000  64
#> 11                     max tns  0.991789 74.000000   0
#> 12                     max fns  0.991789 64.000000   0
#> 13                     max fps  0.006151 74.000000 138
#> 14                     max tps  0.923303 65.000000  64
#> 15                     max tnr  0.991789  1.000000   0
#> 16                     max fnr  0.991789  0.984615   0
#> 17                     max fpr  0.006151  1.000000 138
#> 18                     max tpr  0.923303  1.000000  64
#> 
