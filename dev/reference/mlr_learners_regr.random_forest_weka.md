...
Class for constructing a forest of random trees. Calls
...
- [`LearnerRegrRandomForestWeka$new()`](#method-LearnerRegrRandomForestWeka-initialize)

- [`LearnerRegrRandomForestWeka$marshal()`](#method-LearnerRegrRandomForestWeka-marshal)

- [`LearnerRegrRandomForestWeka$unmarshal()`](#method-LearnerRegrRandomForestWeka-unmarshal)

- [`LearnerRegrRandomForestWeka$clone()`](#method-LearnerRegrRandomForestWeka-clone)
