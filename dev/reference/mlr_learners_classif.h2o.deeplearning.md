...
#> Warning: 
#> Your H2O cluster version is (2 years, 2 months and 27 days) old. There may be a newer version available.
...
#> Model ID:  DeepLearning_model_R_1773963098513_1 
...
#> 2     2   200 Rectifier  0.00 % 0.000000 0.000000  0.004496 0.003088 0.000000
#> 3     3   200 Rectifier  0.00 % 0.000000 0.000000  0.013013 0.048998 0.000000
#> 4     4     2   Softmax      NA 0.000000 0.000000  0.001439 0.000701 0.000000
#>   mean_weight weight_rms mean_bias bias_rms
#> 1          NA         NA        NA       NA
#> 2    0.000971   0.092148  0.491216 0.010087
#> 3   -0.000370   0.069662  0.998110 0.005761
#> 4    0.014636   0.402016  0.000004 0.001597
#> 
#> 
...
#> RMSE:  0.3285828
#> LogLoss:  0.3803684
#> Mean Per-Class Error:  0.01451546
#> AUC:  0.9981203
#> AUCPR:  0.9976844
#> Gini:  0.9962406
#> 
...
#>         M  R    Error    Rate
#> M      75  1 0.013158   =1/76
#> R       1 62 0.015873   =1/63
#> Totals 76 63 0.014388  =2/139
#> 
#> Maximum Metrics: Maximum metrics at their respective thresholds
#>                         metric threshold     value idx
#> 1                       max f1  0.007063  0.984127  60
#> 2                       max f2  0.001908  0.990566  63
#> 3                 max f0point5  0.007063  0.984127  60
#> 4                 max accuracy  0.007063  0.985612  60
#> 5                max precision  1.000000  1.000000   0
#> 6                   max recall  0.001908  1.000000  63
#> 7              max specificity  1.000000  1.000000   0
#> 8             max absolute_mcc  0.007063  0.970969  60
#> 9   max min_per_class_accuracy  0.007063  0.984127  60
#> 10 max mean_per_class_accuracy  0.007063  0.985485  60
#> 11                     max tns  1.000000 76.000000   0
#> 12                     max fns  1.000000 61.000000   0
#> 13                     max fps  0.000000 76.000000 136
#> 14                     max tps  0.001908 63.000000  63
#> 15                     max tnr  1.000000  1.000000   0
#> 16                     max fnr  1.000000  0.968254   0
#> 17                     max fpr  0.000000  1.000000 136
#> 18                     max tpr  0.001908  1.000000  63
#> 
