...
learner$importance()
#>            V9           V49           V11            V6           V51 
#>  2.996617e-02  1.788879e-02  1.331230e-02  1.070803e-02  9.077036e-03 
#>           V52           V12           V48           V55           V27 
#>  7.647923e-03  6.400127e-03  6.325660e-03  5.300333e-03  5.283667e-03 
#>            V4           V46            V5           V10           V13 
#>  4.624090e-03  4.621373e-03  4.368346e-03  2.924487e-03  2.832482e-03 
#>           V56           V37            V7           V22            V3 
#>  2.742165e-03  2.592544e-03  2.459008e-03  2.388956e-03  2.269986e-03 
#>           V26           V45           V15           V53           V25 
#>  2.233147e-03  2.013007e-03  1.550831e-03  1.286055e-03  1.208163e-03 
#>           V34           V14           V24           V23           V38 
#>  1.200000e-03  1.176471e-03  9.666054e-04  8.588287e-04  8.579089e-04 
#>            V1           V39           V57           V42           V21 
#>  8.333333e-04  7.387347e-04  7.377295e-04  6.588046e-04  5.230769e-04 
#>           V32           V17           V41           V18            V2 
#>  4.255319e-04  3.889032e-04  7.304740e-05  0.000000e+00  0.000000e+00 
#>           V29           V31           V44           V43           V28 
#>  0.000000e+00  0.000000e+00 -6.972668e-05 -1.116410e-04 -2.535181e-04 
#>           V33           V35           V47           V40           V16 
#> -3.882469e-04 -3.896870e-04 -4.051149e-04 -4.336879e-04 -6.382823e-04 
#>           V30           V19           V59           V36           V58 
#> -7.192883e-04 -7.312897e-04 -9.056986e-04 -1.168507e-03 -1.412310e-03 
#>           V50           V60           V54           V20            V8 
#> -1.605960e-03 -2.079915e-03 -2.112357e-03 -2.753604e-03 -4.744955e-03 
...
#>        6     R        M 0.5336905 0.4663095
#>        7     R        M 0.7228016 0.2771984
#>        8     R        M 0.6397778 0.3602222
#>      ---   ---      ---       ---       ---
#>      193     M        M 0.8401111 0.1598889
#>      205     M        R 0.4202857 0.5797143
#>      206     M        M 0.7128571 0.2871429
