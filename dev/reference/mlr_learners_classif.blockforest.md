...
learner$importance()
#>           V49            V9            V5           V48           V12 
#>  1.773420e-02  1.749553e-02  1.734326e-02  1.196777e-02  1.079164e-02 
#>           V11           V59            V6           V10           V54 
#>  9.442272e-03  8.300645e-03  6.175626e-03  5.736099e-03  4.818589e-03 
#>           V58            V8           V37           V13           V16 
#>  4.262008e-03  4.238245e-03  3.107407e-03  2.804610e-03  2.723896e-03 
#>           V29           V36           V35           V28            V7 
#>  2.548666e-03  2.454287e-03  2.421481e-03  2.147777e-03  2.021404e-03 
#>           V14           V52           V32           V19           V15 
#>  1.822270e-03  1.711260e-03  1.642026e-03  1.597708e-03  1.369323e-03 
#>           V33           V22           V27            V3           V21 
#>  1.312353e-03  1.306182e-03  1.278846e-03  1.179887e-03  1.121578e-03 
#>           V20            V4           V50           V18           V46 
#>  1.081250e-03  8.743313e-04  8.554070e-04  8.011831e-04  7.595827e-04 
#>           V40            V2           V24           V53           V17 
#>  5.349078e-04  4.195591e-04  2.554726e-04  1.856036e-04  1.057426e-04 
#>           V26           V34           V43           V60           V31 
#>  2.828702e-05  0.000000e+00  0.000000e+00 -7.133056e-05 -8.499525e-05 
#>            V1           V56           V38           V44           V39 
#> -1.281072e-04 -1.594887e-04 -3.371132e-04 -3.595960e-04 -4.308631e-04 
#>           V45           V51           V25           V42           V30 
#> -7.407407e-04 -8.884358e-04 -1.358865e-03 -1.389217e-03 -1.808163e-03 
#>           V57           V23           V55           V41           V47 
#> -2.348596e-03 -2.618522e-03 -2.758844e-03 -3.126172e-03 -5.834665e-03 
...
#>        5     R        R 0.49442857 0.5055714
#>       11     R        R 0.07066667 0.9293333
#>       15     R        R 0.39297619 0.6070238
#>      ---   ---      ---        ---       ---
#>      197     M        M 0.89352381 0.1064762
#>      202     M        M 0.82685714 0.1731429
#>      206     M        M 0.77857143 0.2214286
