...
Classification random forest learner. Calls
[`h2o::h2o.randomForest()`](https://rdrr.io/pkg/h2o/man/h2o.randomForest.html)
...
- [`LearnerClassifH2ORandomForest$new()`](#method-LearnerClassifH2ORandomForest-initialize)

- [`LearnerClassifH2ORandomForest$clone()`](#method-LearnerClassifH2ORandomForest-clone)
...
#> Model ID:  DRF_model_R_1784031075208_58 
#> Model Summary: 
#>   number_of_trees number_of_internal_trees model_size_in_bytes min_depth
#> 1              50                       50               12342         5
#>   max_depth mean_depth min_leaves max_leaves mean_leaves
#> 1        10    6.38000         11         19    15.06000
#> 
#> 
...
#> RMSE:  0.3561432
#> LogLoss:  0.4002309
#> Mean Per-Class Error:  0.1464301
#> AUC:  0.9103362
#> AUCPR:  0.9168443
#> Gini:  0.8206725
#> R^2:  0.491358
...
#>         M  R    Error     Rate
#> M      66  7 0.095890    =7/73
#> R      13 53 0.196970   =13/66
#> Totals 79 60 0.143885  =20/139
#> 
#> Maximum Metrics: Maximum metrics at their respective thresholds
#>                         metric threshold     value idx
#> 1                       max f1  0.533333  0.841270  56
#> 2                       max f2  0.200000  0.877660  96
#> 3                 max f0point5  0.562929  0.872483  54
#> 4                 max accuracy  0.562929  0.856115  54
#> 5                max precision  0.997807  1.000000   0
#> 6                   max recall  0.200000  1.000000  96
#> 7              max specificity  0.997807  1.000000   0
#> 8             max absolute_mcc  0.562929  0.714643  54
#> 9   max min_per_class_accuracy  0.476190  0.833333  61
#> 10 max mean_per_class_accuracy  0.533333  0.853570  56
#> 11                     max tns  0.997807 73.000000   0
#> 12                     max fns  0.997807 65.000000   0
#> 13                     max fps  0.000000 73.000000 115
#> 14                     max tps  0.200000 66.000000  96
#> 15                     max tnr  0.997807  1.000000   0
#> 16                     max fnr  0.997807  0.984848   0
#> 17                     max fpr  0.000000  1.000000 115
#> 18                     max tpr  0.200000  1.000000  96
#> 
