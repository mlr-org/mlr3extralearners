...
#> Model ID:  DRF_model_R_1786110036371_59 
#> Model Summary: 
#>   number_of_trees number_of_internal_trees model_size_in_bytes min_depth
#> 1              50                       50               13121         5
#>   max_depth mean_depth min_leaves max_leaves mean_leaves
#> 1         9    6.58000         12         20    16.28000
#> 
#> 
...
#> Totals 63 76 0.179856  =25/139
#> 
#> Maximum Metrics: Maximum metrics at their respective thresholds
#>                         metric threshold     value idx
#> 1                       max f1  0.375000  0.820144  52
#> 2                       max f2  0.312500  0.893372  59
#> 3                 max f0point5  0.611111  0.807175  29
#> 4                 max accuracy  0.375000  0.820144  52
#> 5                max precision  1.000000  1.000000   0
#> 6                   max recall  0.200000  1.000000  72
#> 7              max specificity  1.000000  1.000000   0
#> 8             max absolute_mcc  0.375000  0.654762  52
#> 9   max min_per_class_accuracy  0.437500  0.763158  45
#> 10 max mean_per_class_accuracy  0.375000  0.827381  52
#> 11                     max tns  1.000000 76.000000   0
#> 12                     max fns  1.000000 60.000000   0
#> 13                     max fps  0.000000 76.000000  85
#> 14                     max tps  0.200000 63.000000  72
