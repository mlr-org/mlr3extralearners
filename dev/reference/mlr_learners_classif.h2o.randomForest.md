...
#> Model ID:  DRF_model_R_1776186279408_58 
#> Model Summary: 
#>   number_of_trees number_of_internal_trees model_size_in_bytes min_depth
#> 1              50                       50               13198         5
#>   max_depth mean_depth min_leaves max_leaves mean_leaves
#> 1        10    6.70000         11         24    16.40000
#> 
#> 
...
#> RMSE:  0.380221
#> LogLoss:  0.4405318
#> Mean Per-Class Error:  0.1799376
#> AUC:  0.8742204
#> AUCPR:  0.87482
#> Gini:  0.7484407
#> R^2:  0.4192936
...
#> R      19 46 0.292308   =19/65
#> Totals 88 51 0.172662  =24/139
#> 
#> Maximum Metrics: Maximum metrics at their respective thresholds
#>                         metric threshold     value idx
#> 1                       max f1  0.550000  0.793103  34
#> 2                       max f2  0.285714  0.879888  64
#> 3                 max f0point5  0.550000  0.855019  34
#> 4                 max accuracy  0.550000  0.827338  34
#> 5                max precision  1.000000  1.000000   0
#> 6                   max recall  0.181818  1.000000  74
#> 7              max specificity  1.000000  1.000000   0
#> 8             max absolute_mcc  0.550000  0.662690  34
#> 9   max min_per_class_accuracy  0.454545  0.729730  45
#> 10 max mean_per_class_accuracy  0.550000  0.820062  34
#> 11                     max tns  1.000000 74.000000   0
#> 12                     max fns  1.000000 62.000000   0
#> 13                     max fps  0.000000 74.000000  94
#> 14                     max tps  0.181818 65.000000  74
#> 15                     max tnr  1.000000  1.000000   0
#> 16                     max fnr  1.000000  0.953846   0
#> 17                     max fpr  0.000000  1.000000  94
#> 18                     max tpr  0.181818  1.000000  74
#> 
