...
#>  190.611 138 2.15016e-05 124          1      30    25         0
#> 
#> Earth selected 15 of 22 terms, and 11 of 60 predictors
#> Termination condition: RSq changed by less than 0.001 at 22 terms
#> Importance: V11, V36, V43, V28, V17, V20, V47, V54, V9, V2, V34, V1-unused, ...
#> Number of terms at each degree of interaction: 1 14 (additive model)
#> Earth GCV 0.1103874    RSS 9.609261    GRSq 0.5581721    RSq 0.7192755
