...
Quantile Regression with generalized additive models. Calls
[`qgam::qgam()`](https://rdrr.io/pkg/qgam/man/qgam.html) from package
...
The quantile for the Learner, i.e. `qu` parameter from
[`qgam::qgam()`](https://rdrr.io/pkg/qgam/man/qgam.html), is set using
the value specified in `learner$quantiles`.
...
- [`LearnerRegrQGam$new()`](#method-LearnerRegrQGam-initialize)

- [`LearnerRegrQGam$clone()`](#method-LearnerRegrQGam-clone)
