...
Simple Decision Table majority regressor. Calls
...
- `E`:
  ...
  - Has only 2 out of 4 original evaluation measures : rmse and mae with
    rmse being the default

  - Reason for change: this learner should only contain evaluation
    measures appropriate for regression tasks
...
- [`LearnerRegrDecisionTable$new()`](#method-LearnerRegrDecisionTable-new)

- [`LearnerRegrDecisionTable$marshal()`](#method-LearnerRegrDecisionTable-marshal)

- [`LearnerRegrDecisionTable$unmarshal()`](#method-LearnerRegrDecisionTable-unmarshal)

- [`LearnerRegrDecisionTable$clone()`](#method-LearnerRegrDecisionTable-clone)
...
#>  Total number of subsets evaluated: 66
#>  Merit of best subset found:    3.414
#> Evaluation (for feature selection): CV (leave one out) 
#> Feature set: 2,5,7,10,1
