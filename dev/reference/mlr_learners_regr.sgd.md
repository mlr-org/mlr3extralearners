...
#> 
#>          3.408  (normalized) am
#>  +      -7.8576 (normalized) carb
#>  +       3.2462 (normalized) cyl
#>  +       2.493  (normalized) disp
#>  +       7.2933 (normalized) drat
#>  +       5.1676 (normalized) gear
#>  +      -2.0334 (normalized) hp
#>  +       6.4064 (normalized) qsec
#>  +       1.4794 (normalized) vs
#>  +      -5.9856 (normalized) wt
#>  +      13.0445
