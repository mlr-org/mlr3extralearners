...
- `F`:
  ...
  - Has only 3 out of 5 original loss functions: 2 = squared loss
    (regression), 3 = epsilon insensitive loss (regression) and 4 =
    Huber loss (regression) with 2 (squared loss) being the new default
...
- [`LearnerRegrSGD$unmarshal()`](#method-LearnerRegrSGD-unmarshal)

- [`LearnerRegrSGD$clone()`](#method-LearnerRegrSGD-clone)
...
#> mpg = 
#> 
#>          3.7184 (normalized) am
#>  +      -3.3979 (normalized) carb
#>  +       4.2547 (normalized) cyl
#>  +      -1.7637 (normalized) disp
#>  +       4.4716 (normalized) drat
#>  +       0.3431 (normalized) gear
#>  +      -2.8244 (normalized) hp
#>  +      10.5542 (normalized) qsec
#>  +      -0.8126 (normalized) vs
#>  +      -8.1614 (normalized) wt
#>  +      12.9538
