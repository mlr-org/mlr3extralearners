...
#> mpg = 
#> 
#>          3.7426 (normalized) am
#>  +      -7.0814 (normalized) carb
#>  +       6.6358 (normalized) cyl
#>  +       0.1492 (normalized) disp
#>  +       5.2864 (normalized) drat
#>  +       4.4308 (normalized) gear
#>  +      -3.1097 (normalized) hp
#>  +       6.767  (normalized) qsec
#>  +       1.308  (normalized) vs
#>  +      -8.1099 (normalized) wt
#>  +      16.5367
