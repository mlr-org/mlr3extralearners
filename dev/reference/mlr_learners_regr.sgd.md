...
#> 
#>          6.901  (normalized) am
#>  +      -7.8963 (normalized) carb
#>  +       0.2778 (normalized) cyl
#>  +       5.0861 (normalized) disp
#>  +       7.2375 (normalized) drat
#>  +       1.5281 (normalized) gear
#>  +      -1.6972 (normalized) hp
#>  +       7.7559 (normalized) qsec
#>  +       0.7991 (normalized) vs
#>  +      -1.5941 (normalized) wt
#>  +      11.0042
