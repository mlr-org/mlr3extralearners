...
#> mpg = 
#> 
#>          2.7282 (normalized) am
#>  +      -3.2156 (normalized) carb
#>  +       3.9932 (normalized) cyl
#>  +      -1.0819 (normalized) disp
#>  +       4.3859 (normalized) drat
#>  +       2.0406 (normalized) gear
#>  +      -3.6    (normalized) hp
#>  +       5.7695 (normalized) qsec
#>  +       1.0074 (normalized) vs
#>  +      -7.5295 (normalized) wt
#>  +      17.1926
