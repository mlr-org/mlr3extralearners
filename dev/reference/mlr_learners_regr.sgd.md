...
#> mpg = 
#> 
#>          0.8333 (normalized) am
#>  +      -4.0595 (normalized) carb
#>  +       2.2888 (normalized) cyl
#>  +      -0.6634 (normalized) disp
#>  +       3.4904 (normalized) drat
#>  +       3.3811 (normalized) gear
#>  +      -5.398  (normalized) hp
#>  +       3.7238 (normalized) qsec
#>  +       0.3443 (normalized) vs
#>  +      -7.9258 (normalized) wt
#>  +      21.469 
