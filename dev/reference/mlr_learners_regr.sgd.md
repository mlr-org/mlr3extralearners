...
#> mpg = 
#> 
#>          4.3005 (normalized) am
#>  +      -5.6108 (normalized) carb
#>  +       3.3749 (normalized) cyl
#>  +      -0.3641 (normalized) disp
#>  +      -2.076  (normalized) drat
#>  +       2.6191 (normalized) gear
#>  +      -4.747  (normalized) hp
#>  +       6.7087 (normalized) qsec
#>  +       2.6538 (normalized) vs
#>  +      -6.0041 (normalized) wt
#>  +      18.6143
