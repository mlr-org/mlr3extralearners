...
#> mpg = 
#> 
#>          4.6626 (normalized) am
#>  +      -3.5145 (normalized) carb
#>  +       4.1929 (normalized) cyl
#>  +      -1.2138 (normalized) disp
#>  +       3.6146 (normalized) drat
#>  +      -0.6372 (normalized) gear
#>  +      -6.121  (normalized) hp
#>  +       8.1513 (normalized) qsec
#>  +       1.0509 (normalized) vs
#>  +      -5.31   (normalized) wt
#>  +      15.971 
