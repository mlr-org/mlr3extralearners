...
#> mpg = 
#> 
#>          4.9389 (normalized) am
#>  +      -3.9811 (normalized) carb
#>  +       1.4498 (normalized) cyl
#>  +       0.4355 (normalized) disp
#>  +      -0.0888 (normalized) drat
#>  +       2.1695 (normalized) gear
#>  +      -5.1689 (normalized) hp
#>  +       6.1677 (normalized) qsec
#>  +       1.403  (normalized) vs
#>  +      -2.5726 (normalized) wt
#>  +      16.6415
