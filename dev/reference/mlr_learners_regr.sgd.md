...
#> mpg = 
#> 
#>          4.5763 (normalized) am
#>  +      -2.444  (normalized) carb
#>  +       4.8517 (normalized) cyl
#>  +      -2.4848 (normalized) disp
#>  +       0.6    (normalized) drat
#>  +       0.4832 (normalized) gear
#>  +      -3.1093 (normalized) hp
#>  +       6.1283 (normalized) qsec
#>  +       3.2053 (normalized) vs
#>  +      -8.6005 (normalized) wt
#>  +      17.9353
