...
#> 
#>          4.337  (normalized) am
#>  +      -2.1335 (normalized) carb
#>  +       0.9905 (normalized) cyl
#>  +       1.9495 (normalized) disp
#>  +       6.8653 (normalized) drat
#>  +      -0.986  (normalized) gear
#>  +      -3.949  (normalized) hp
#>  +      10.0013 (normalized) qsec
#>  +      -0.7045 (normalized) vs
#>  +      -3.229  (normalized) wt
#>  +      12.3141
