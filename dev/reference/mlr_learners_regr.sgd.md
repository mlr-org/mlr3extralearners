...
#> 
#>          6.554  (normalized) am
#>  +      -7.3429 (normalized) carb
#>  +       0.6585 (normalized) cyl
#>  +      -1.6065 (normalized) disp
#>  +      -1.1106 (normalized) drat
#>  +       0.7726 (normalized) gear
#>  +      -2.2643 (normalized) hp
#>  +       4.7683 (normalized) qsec
#>  +       2.6058 (normalized) vs
#>  +      -1.9901 (normalized) wt
#>  +      18.6381
