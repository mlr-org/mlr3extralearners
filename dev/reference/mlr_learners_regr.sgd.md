...
#> mpg = 
#> 
#>          4.0414 (normalized) am
#>  +      -5.7345 (normalized) carb
#>  +       0.5688 (normalized) cyl
#>  +       1.4549 (normalized) disp
#>  +       4.6271 (normalized) drat
#>  +       1.8818 (normalized) gear
#>  +      -2.025  (normalized) hp
#>  +       6.6437 (normalized) qsec
#>  +       0.7413 (normalized) vs
#>  +      -7.7095 (normalized) wt
#>  +      16.5485
