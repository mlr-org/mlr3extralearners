...
#> mpg = 
#> 
#>          2.2394 (normalized) am
#>  +      -3.6118 (normalized) carb
#>  +       1.8499 (normalized) cyl
#>  +       3.0769 (normalized) disp
#>  +       3.6372 (normalized) drat
#>  +       3.0798 (normalized) gear
#>  +      -3.177  (normalized) hp
#>  +      10.6033 (normalized) qsec
#>  +      -1.467  (normalized) vs
#>  +      -9.5416 (normalized) wt
#>  +      18.3491
