...
#> 
#>          4.742  (normalized) am
#>  +      -9.3635 (normalized) carb
#>  +       4.5458 (normalized) cyl
#>  +       1.9751 (normalized) disp
#>  +       3.9471 (normalized) drat
#>  +       4.4183 (normalized) gear
#>  +      -1.0281 (normalized) hp
#>  +       6.1045 (normalized) qsec
#>  +       1.4051 (normalized) vs
#>  +      -8.0621 (normalized) wt
#>  +      14.3537
