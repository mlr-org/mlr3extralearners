...
#> mpg = 
#> 
#>          0.8139 (normalized) am
#>  +      -3.3987 (normalized) carb
#>  +       2.4478 (normalized) cyl
#>  +      -0.9733 (normalized) disp
#>  +       0.7034 (normalized) drat
#>  +       4.9563 (normalized) gear
#>  +      -3.644  (normalized) hp
#>  +       3.8628 (normalized) qsec
#>  +       0.5073 (normalized) vs
#>  +      -5.7342 (normalized) wt
#>  +      20.2301
