...
#> 
#>          5.53   (normalized) am
#>  +      -8.72   (normalized) carb
#>  +       3.8725 (normalized) cyl
#>  +       3.3462 (normalized) disp
#>  +       3.9205 (normalized) drat
#>  +       5.4223 (normalized) gear
#>  +      -1.0636 (normalized) hp
#>  +       4.8857 (normalized) qsec
#>  +       2.5808 (normalized) vs
#>  +      -3.9938 (normalized) wt
#>  +      13.9474
