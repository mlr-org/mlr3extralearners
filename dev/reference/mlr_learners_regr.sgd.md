...
#> mpg = 
#> 
#>          5.7117 (normalized) am
#>  +      -4.4662 (normalized) carb
#>  +       3.2225 (normalized) cyl
#>  +      -2.1161 (normalized) disp
#>  +      -1.9831 (normalized) drat
#>  +       1.259  (normalized) gear
#>  +      -1.6443 (normalized) hp
#>  +       5.9913 (normalized) qsec
#>  +       3.1923 (normalized) vs
#>  +      -4.674  (normalized) wt
#>  +      18.0733
