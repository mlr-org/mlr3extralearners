...
#> mpg = 
#> 
#>          1.2047 (normalized) am
#>  +      -2.8731 (normalized) carb
#>  +       3.5842 (normalized) cyl
#>  +      -4.2451 (normalized) disp
#>  +       8.0909 (normalized) drat
#>  +       0.0791 (normalized) gear
#>  +      -4.977  (normalized) hp
#>  +       5.417  (normalized) qsec
#>  +       1.0404 (normalized) vs
#>  +      -4.6111 (normalized) wt
#>  +      17.912 
