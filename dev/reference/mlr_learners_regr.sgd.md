...
#> mpg = 
#> 
#>          6.1266 (normalized) am
#>  +      -6.4249 (normalized) carb
#>  +       1.6704 (normalized) cyl
#>  +       0.7501 (normalized) disp
#>  +      -0.4975 (normalized) drat
#>  +       0.1643 (normalized) gear
#>  +      -1.5352 (normalized) hp
#>  +       4.6474 (normalized) qsec
#>  +       4.0367 (normalized) vs
#>  +      -4.767  (normalized) wt
#>  +      16.6197
