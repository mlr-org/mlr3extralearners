...
Instance-based regressor which differs from other instance-based
...
- [`LearnerRegrKStar$unmarshal()`](#method-LearnerRegrKStar-unmarshal)

- [`LearnerRegrKStar$clone()`](#method-LearnerRegrKStar-clone)
