...
[`tgp::bgp()`](https://rdrr.io/pkg/tgp/man/btgp.html) from
...
- [`LearnerRegrBgp$new()`](#method-LearnerRegrBgp-initialize)

- [`LearnerRegrBgp$clone()`](#method-LearnerRegrBgp-clone)
