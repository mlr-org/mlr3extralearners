...
#>  +       0.129  * (normalized) am
#>  -       0.1108 * (normalized) carb
#>  +       0.099  * (normalized) cyl
#>  +       0.0382 * (normalized) disp
#>  +       0.0141 * (normalized) drat
#>  +       0.2447 * (normalized) gear
#>  -       0.0366 * (normalized) hp
#>  +       0.1244 * (normalized) qsec
#>  +       0.1196 * (normalized) vs
#>  -       0.4526 * (normalized) wt
#>  +       0.4179
#> 
#> 
#> 
