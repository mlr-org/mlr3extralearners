...
#>  +       0.0299 * (normalized) am
#>  -       0.1549 * (normalized) carb
#>  -       0.25   * (normalized) cyl
#>  -       0.0995 * (normalized) disp
#>  -       0.1302 * (normalized) drat
#>  +       0.0993 * (normalized) gear
#>  -       0.0369 * (normalized) hp
#>  -       0.0073 * (normalized) qsec
#>  +       0.0706 * (normalized) vs
#>  -       0.4045 * (normalized) wt
#>  +       0.8572
#> 
#> 
#> 
