...
Voted Perceptron Algorithm by Freund and Schapire. Calls
...
Freund Y, Schapire RE (1998). “Large margin classification using the
perceptron algorithm.” In *11th Annual Conference on Computational
Learning Theory*, 209-217.
...
- [`LearnerClassifVotedPerceptron$unmarshal()`](#method-LearnerClassifVotedPerceptron-unmarshal)

- [`LearnerClassifVotedPerceptron$clone()`](#method-LearnerClassifVotedPerceptron-clone)
...
print(learner$model)
#> VotedPerceptron: Number of perceptrons=68
