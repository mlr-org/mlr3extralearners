...
Simple linear regression model that picks the attribute that results in
the lowest squared error. Calls
...
- [`LearnerRegrSimpleLinearRegression$unmarshal()`](#method-LearnerRegrSimpleLinearRegression-unmarshal)

- [`LearnerRegrSimpleLinearRegression$clone()`](#method-LearnerRegrSimpleLinearRegression-clone)
...
print(learner)
#> 
#> ── <LearnerRegrSimpleLinearRegression> (regr.simple_linear_regression): Simple L
#> • Model: -
#> • Parameters: list()
