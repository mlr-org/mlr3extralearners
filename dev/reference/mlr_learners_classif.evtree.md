...
#> Fitted party:
#> [1] root
#> |   [2] V43 < 0.0758: R (n = 10, err = 20.0%)
#> |   [3] V43 >= 0.0758
#> |   |   [4] V4 < 0.0818
#> |   |   |   [5] V16 < 0.3731
#> |   |   |   |   [6] V11 < 0.2118: R (n = 34, err = 2.9%)
#> |   |   |   |   [7] V11 >= 0.2118: M (n = 35, err = 5.7%)
#> |   |   |   [8] V16 >= 0.3731
#> |   |   |   |   [9] V26 < 0.5599: M (n = 10, err = 10.0%)
#> |   |   |   |   [10] V26 >= 0.5599
#> |   |   |   |   |   [11] V23 < 0.875: R (n = 16, err = 0.0%)
#> |   |   |   |   |   [12] V23 >= 0.875: M (n = 10, err = 0.0%)
#> |   |   [13] V4 >= 0.0818: M (n = 24, err = 16.7%)
#> 
