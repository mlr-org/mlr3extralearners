...
#> |   [2] V32 < 0.4463
#> |   |   [3] V21 < 0.8017
#> |   |   |   [4] V12 < 0.2251: R (n = 16, err = 0.0%)
#> |   |   |   [5] V12 >= 0.2251: M (n = 23, err = 8.7%)
#> |   |   [6] V21 >= 0.8017
#> |   |   |   [7] V44 < 0.1359: R (n = 9, err = 22.2%)
#> |   |   |   [8] V44 >= 0.1359: M (n = 25, err = 0.0%)
#> |   [9] V32 >= 0.4463
#> |   |   [10] V11 < 0.1796: R (n = 34, err = 8.8%)
#> |   |   [11] V11 >= 0.1796
#> |   |   |   [12] V6 < 0.1589: M (n = 22, err = 9.1%)
#> |   |   |   [13] V6 >= 0.1589: R (n = 10, err = 10.0%)
#> 
