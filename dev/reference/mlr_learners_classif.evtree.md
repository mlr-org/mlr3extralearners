...
#> |   [2] V18 < 0.4576
#> |   |   [3] V10 < 0.2127
#> |   |   |   [4] V47 < 0.1554: R (n = 41, err = 9.8%)
#> |   |   |   [5] V47 >= 0.1554: M (n = 15, err = 0.0%)
#> |   |   [6] V10 >= 0.2127: M (n = 28, err = 3.6%)
#> |   [7] V18 >= 0.4576
#> |   |   [8] V17 < 0.7231
#> |   |   |   [9] V37 < 0.4577: M (n = 21, err = 14.3%)
#> |   |   |   [10] V37 >= 0.4577: R (n = 7, err = 0.0%)
#> |   |   [11] V17 >= 0.7231
#> |   |   |   [12] V27 < 0.5601: M (n = 8, err = 0.0%)
#> |   |   |   [13] V27 >= 0.5601: R (n = 19, err = 5.3%)
#> 
