...
Bayesian linear regression model. Calls
[`tgp::blm()`](https://rdrr.io/pkg/tgp/man/btgp.html) from
...
- [`LearnerRegrBlm$new()`](#method-LearnerRegrBlm-initialize)

- [`LearnerRegrBlm$clone()`](#method-LearnerRegrBlm-clone)
...
print(learner)
#> 
#> ── <LearnerRegrBlm> (regr.blm): Bayesian Linear Model ──────────────────────────
#> • Model: -
